...
class _TicketChatScreenState extends ConsumerState<TicketChatScreen> {
  ...
  Future<void> _init() async {
    final response = await ref.read(supportApiProvider).getMessages(widget.ticketId, {'page': 1, 'limit': 100});
  ...
  Future<void> _send() async {
    ...
    await ref.read(supportApiProvider).sendMessage(widget.ticketId, {'message': text});
  }
            ...
            child: _loading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isUser = (m['senderType'] as String).toLowerCase() == 'user';
                      return Align(
